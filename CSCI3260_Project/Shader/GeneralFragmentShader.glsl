...
void main()
{
	...
	if(multipleTexture == 1){
		textureColor = (0.7*wiredMotion*texture( textureSampler1, UV ) + 0.3*texture( textureSampler2, UV ) + 0.7*(1-wiredMotion)*texture( textureSampler3, UV )).rgb;
	}
	else{
